...
# There is a moderate [security issue](https://github.com/psf/requests/pull/6655). Update will be released soon.
...
|      `tags`      |    `str`    |     String with valid tags separated by spaces      | String that represents a search on e926[^3]. If you want to send favourites in the order they were added, specify `fav:!{user_id}` as the only tag.                             |
